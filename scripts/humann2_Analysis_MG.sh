...
WORKINGDIR="$SCRATCH"/humann2_MG_Analysis
DATAOUTDIR="$WORKINGDIR"/"$DATADIR"_Out
#$SCRATCH/humann2_MG_Analysis/trimMG_Out

### Setup the $SCRATCH Dir ###
mkdir $WORKINGDIR
cp -r $DATA $WORKINGDIR
#$PROJECT/benjijp/trimMG -> $SCRATCH/humann2_MG_Analysis/trimMG
cd $WORKINGDIR

# Setup the Utility Mapping Database
UTILITYDB="$WORKINGDIR"/humann2UtilityDB
#$SCRATCH/humann2_MG_Analysis/humann2UtilityDB
...
#SCRATCH/humann2_MG_Analysis/trimMG
